...
4. [If performance concerns: follow `skills/swiftui-performance-analyzer.md`]
```
...
For performance issues: `skills/swiftui-performance-analyzer.md`
For navigation architecture: follow `skills/swiftui-nav-auditor.md`
