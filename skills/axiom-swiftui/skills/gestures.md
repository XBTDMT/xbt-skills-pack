...
- UIKit-side pointer and hardware-keyboard APIs (`UIPointerInteraction`, `UIKeyCommand`) are UIKit topics outside this skill; mouse/keyboard as *game* input (`GCMouse`, `GCKeyboard`) is GameController framework, also outside this skill.
...
**Skills**: skills/swiftui-performance.md
