...
**Related skills**: `skills/swiftui-performance.md` (profiling with Instruments), `skills/layout.md` (adaptive layout patterns)
...
#### This is an Xcode build/cache problem, not a SwiftUI one, when
- App crashes at runtime (not preview)
- Build fails completely
- You need environment diagnostics

#### This is a Swift concurrency problem, not a SwiftUI one, when
...
**Skills**: skills/swiftui-performance.md, skills/debugging-diag.md
