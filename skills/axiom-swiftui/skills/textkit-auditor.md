...
For TextKit 2 architecture and migration patterns: Apple's TextKit 2 documentation (outside this skill)
For SwiftUI wrappers re-creating text views on every render: `skills/swiftui-performance-analyzer.md`
