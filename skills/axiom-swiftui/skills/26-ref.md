...
**This section covers WWDC 256-specific APIs only**; design principles and the app-wide adoption guide are in Apple's Liquid Glass documentation.
...
**HIG constraint** — do not put an index on a list whose rows carry trailing controls such as disclosure indicators. Both occupy the trailing edge and users cannot reliably hit one without the other.
