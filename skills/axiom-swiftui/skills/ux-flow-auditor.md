...
Follow this file inline; it needs only file search and read.
...
**Scope**: User journeys, not code patterns. For code-level checks, use the specialized auditors in this suite (`skills/swiftui-nav-auditor.md`, etc.).
...
For accessibility compliance and UX principles: Apple's Accessibility and Human Interface Guidelines (outside this skill)
